        ...
        <div className="lg:w-1/3">
          <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-violet-400">
              <img className="flex items-center justify-center w-12 h-12  rounded-full bg-violet-400" src="https://i.postimg.cc/2jxLBCnM/travel-tour-landscape-sun-airplane-260nw-366089225.webp" alt="" />
            ...
            <span className="self-center text-2xl font-semibold">UnitedTrip</span>
          </a>
        </div>
